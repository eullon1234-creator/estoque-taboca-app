        ...
        const renderProducts = () => {
            ...
            paginatedProducts.forEach(p => {
                ...
                tr.innerHTML = `
                    ...
                    <td class="p-4 align-top"><div class="flex items-center gap-2"><p class="text-lg font-bold text-slate-800">${p.quantity}</p>${isLowStock ? '<span class="px-2 py-0.5 text-xs font-semibold text-yellow-800 bg-yellow-100 rounded-full status-indicator-low ml-2">Baixo</span>' : ''}</div></td>
